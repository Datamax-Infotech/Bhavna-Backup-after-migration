...
$carrier_name = " ";
$destination_id = 7;
$title_name = "Crest Foods - Dashboard";
$return_url = "dashboard_CF_734553548324134553845.php";
$items = 5;
db();
?>
<!DOCTYPE HTML>
		...
		<tr>
			...
			<td align=center colspan="3">
				<font face="Ariel" size="5">
					...
					<b><i><?php echo $warehouse_name; ?></i></b>
					</i>
			</td>
				...
				<FORM METHOD="POST" ACTION="BOLpickupsubmitNEW.php" name="BOL" id="BOL">
					...
					<TABLE ALIGN='LEFT' width="450">
						...
						<TR>
							...
							<TD bgColor="#e4e4e4" class="style12" CLASS='TBL_ROW_HDR' colspan="2" style="text-align: left">
								...
								<input type="text" name="pickup_date" size="11" value="<?php echo (isset($_REQUEST["pickup_date"]) && $_REQUEST["pickup_date"] != "") ? date('m/d/Y', $pickup_date) : date('m/d/Y') ?>"> <a href="#" onclick="cal0xx.select(document.BOL.pickup_date,'anchor0xx','MM/dd/yyyy'); return false;" name="anchor0xx" id="anchor0xx"><img border="0" src="images/calendar.jpg"></a>
						...
						<TR>
							...
							<TD bgColor="#e4e4e4" class="style12" CLASS='TBL_ROW_HDR' style="text-align: left">
								<font size="2" face="Arial">
									34 inch Totes<input type="hidden" name="item_2" value="34 inch Totes">
								</font>
							</TD>
						</TR>
						<TR>
							...
							<TD bgColor="#e4e4e4" class="style12" CLASS='TBL_ROW_HDR' style="text-align: left">
								<font size="2" face="Arial">
									4 Way White Wood Pallets<input type="hidden" name="item_3" value="4 Way White Wood Pallets">
								</font>
							</TD>
						</TR>
						<TR>
