...
<head>
    ...
    function loadfrm(field_val) {
        ...
        if (field_val == 5) {
            document.getElementById("sort").value = "acc_status";
        }
        if (field_val == 6) {
    ...
    <div class="main_data_css">
        ...
        <div class="dashboard_heading" style="float: left;">
            ...
            &nbsp;<div class="tooltip"><i class="fa fa-info-circle" aria-hidden="true"></i>
                <span class="tooltiptext">This report shows the user all of the instances where this inventory item was
                    quoted and the status of those quotes.</span>
            </div>
...
-->
                        <div><i>Note: Please wait until you see <font color="red">"END OF REPORT"</font> at the bottom
                                of the report, before using the sort option.</i></div>
                        ...
                        <table width="1100px" border="0" cellspacing="2" cellpadding="2" bgcolor="#E4E4E4">
                            ...
                            <tr align="center">
                                ...
                                <td colspan="2" bgcolor="#C0CDDA">
                                    <font face="Arial, Helvetica, sans-serif" size="1" color="#333333">GAYLORDS</font>
                                </td>
                            ...
                            <tr align="center">
                                ...
                                <td colspan="2" align="left" bgcolor="#C0CDDA">
                            ...
                            <tr>
                                <td colspan="3">
                                    ...
                                    <select name="transactionType" id="transactionType">
                                        ...
                                        <option value='1'
                                            <?php echo ($_REQUEST['transactionType'] == '1') ? ' selected' : ''; ?>>
                                            UsedCardboardBoxes</option>
                                        <option value='2'
                                            <?php echo ($_REQUEST['transactionType'] == '2') ? ' selected' : ''; ?>>
                                            UCBPalletSolutions</option>
                                        <option value='3'
                                            <?php echo ($_REQUEST['transactionType'] == '3') ? ' selected' : ''; ?>>
                                            UCBZeroWaste</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="right">
                                    <input type="checkbox" name="showall_emp" id="showall_emp" value="yes" <?php if (empty($_REQUEST["showall_emp"])) {
																											} else {
																												echo " checked ";
																											} ?> onclick="if(this.checked){this.form.submit()}else{this.form.submit()}">Show only my
                                    record(s)
                                </td>
                            </tr>
                    ...
                    <form name="frmrep" action="report_find_quoters.php" method="post">
                        <br>
                        <?php
						$sorturl = "report_find_quoters.php?inventoryID=" . $_REQUEST['inventoryID'] . "&employeeID=" . $_REQUEST['employeeID'] . "&transactionType=" . $_REQUEST['transactionType'];
                        ...
                        <table width="1100px" border="0" cellspacing="2" cellpadding="2" bgcolor="#E4E4E4"
                            ...
                            <tr align="center">
                                <th bgcolor="#C0CDDA"
                                    style="font-weight:bold;background:#C0CDDA; padding:5px 15px; border:0 none;cursor:pointer;">
                                    Sr. No.</th>

                                <th bgColor="#C0CDDA" style="height: 16px" align="middle">
                                    <strong>Quote Date</strong>
                                    <font size="1" face="Arial, Helvetica, sans-serif" color="#333333">&nbsp;<a
                                            href="<?php echo $sorturl; ?>&sort_order_pre=ASC&sort=quote_date"><img
                                                src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a
                                            href="<?php echo $sorturl; ?>&sort_order_pre=DESC&sort=quote_date"><img
                                ...
                                <th bgColor="#C0CDDA" style="height: 16px" align="middle">
                                    ...
                                    <font size="1" face="Arial, Helvetica, sans-serif" color="#333333">&nbsp;<a
                                            href="<?php echo $sorturl; ?>&sort_order_pre=ASC&sort=quote_id"><img
                                                src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a
                                            href="<?php echo $sorturl; ?>&sort_order_pre=DESC&sort=quote_id"><img
                                                src="images/sort_desc.png" width="6px;" height="12px;"></a>
                                    </font>
                                ...
                                <th bgColor="#C0CDDA" style="height: 16px" align="middle">
                                    ...
                                    <font size="1" face="Arial, Helvetica, sans-serif" color="#333333">&nbsp;<a
                                            href="<?php echo $sorturl; ?>&sort_order_pre=ASC&sort=company_name"><img
                                                src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a
                                            href="<?php echo $sorturl; ?>&sort_order_pre=DESC&sort=company_name"><img
                                                src="images/sort_desc.png" width="6px;" height="12px;"></a>
                                    </font>
                                ...
                                <th bgColor="#C0CDDA" style="height: 16px" align="middle">
                                    <strong>Rep</strong>
                                    <font size="1" face="Arial, Helvetica, sans-serif" color="#333333">&nbsp;<a
                                            href="<?php echo $sorturl; ?>&sort_order_pre=ASC&sort=account_owner"><img
                                                src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a
                                            href="<?php echo $sorturl; ?>&sort_order_pre=DESC&sort=account_owner"><img
                                                src="images/sort_desc.png" width="6px;" height="12px;"></a>
                                    </font>
                                </th>
                                ...
                                <th bgColor="#C0CDDA" style="height: 16px" align="middle">
                                    ...
                                    <font size="1" face="Arial, Helvetica, sans-serif" color="#333333">&nbsp;<a
                                            href="<?php echo $sorturl; ?>&sort_order_pre=ASC&sort=lastcrmdt"><img
                                                src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a
                                            href="<?php echo $sorturl; ?>&sort_order_pre=DESC&sort=lastcrmdt"><img
                                                src="images/sort_desc.png" width="6px;" height="12px;"></a>
                                    </font>
                                </th>
                                ...
                                <th bgColor="#C0CDDA" style="height: 16px" align="middle">
                                    ...
                                    <font size="1" face="Arial, Helvetica, sans-serif" color="#333333">&nbsp;<a
                                            href="<?php echo $sorturl; ?>&sort_order_pre=ASC&sort=industry_sort"><img
                                                src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a
                                            href="<?php echo $sorturl; ?>&sort_order_pre=DESC&sort=industry_sort"><img
                                                src="images/sort_desc.png" width="6px;" height="12px;"></a>
                                    </font>
                                </th>
                                ...
                                <th bgColor="#C0CDDA" style="height: 16px" align="middle">
                                    ...
                                    <font size="1" face="Arial, Helvetica, sans-serif" color="#333333">&nbsp;<a
                                            href="<?php echo $sorturl; ?>&sort_order_pre=ASC&sort=acc_status"><img
                                                src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a
                                            href="<?php echo $sorturl; ?>&sort_order_pre=DESC&sort=acc_status"><img
                                                src="images/sort_desc.png" width="6px;" height="12px;"></a>
                                    </font>
                                </th>
                                <th bgColor="#C0CDDA" style="height: 16px" align="middle">
                                    ...
                                    <font size="1" face="Arial, Helvetica, sans-serif" color="#333333">&nbsp;<a
                                            href="<?php echo $sorturl; ?>&sort_order_pre=ASC&sort=qut_price"><img
                                                src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a
                                            href="<?php echo $sorturl; ?>&sort_order_pre=DESC&sort=qut_price"><img
                                                src="images/sort_desc.png" width="6px;" height="12px;"></a>
                                </th>
                                <th bgColor="#C0CDDA" style="height: 16px" align="middle">
                                    <strong>Quoted <br>Delivered<br> Price</strong>
                                    <font size="1" face="Arial, Helvetica, sans-serif" color="#333333">&nbsp;<a
                                            href="<?php echo $sorturl; ?>&sort_order_pre=ASC&sort=qut_del_price"><img
                                                src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a
                                            href="<?php echo $sorturl; ?>&sort_order_pre=DESC&sort=qut_del_price"><img
                                                src="images/sort_desc.png" width="6px;" height="12px;"></a>
                                </th>
                                <th bgColor="#C0CDDA" style="height: 16px" align="middle">
                                    <strong>Quoted Status</strong>
                                    <font size="1" face="Arial, Helvetica, sans-serif" color="#333333">&nbsp;<a
                                            href="<?php echo $sorturl; ?>&sort_order_pre=ASC&sort=qut_status"><img
                                                src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a
                                            href="<?php echo $sorturl; ?>&sort_order_pre=DESC&sort=qut_status"><img
                                                src="images/sort_desc.png" width="6px;" height="12px;"></a>
                                </th>
								...
								if ($numrec > 0) {
									...
									while ($objGBmatch = array_shift($queryb)) {
										...
										if ($qt != "") {
											...
											db_b2b(); //. $transTypeQry
											$getIndustryFromCompanyInfo = db_query("SELECT industry_id FROM companyInfo WHERE ID = " . $objGBmatch["companyid"] . $transTypeQry);
                            ...
                            <tr>
                                ...
                                <td> <a href="viewCompany.php?ID=<?php echo $objGBmatch["companyid"] ?>"
                                        target="_blank"><?php echo $nickname; ?> </a></td>
                            ...
                            <?php
										...
										$MGArray[] = array(
											'companyID' => $objGBmatch["companyid"],
											'company_name' => trim($nickname),
											'selltoemail' => trim($objGBmatch["sell_to_email"]),
											'quoted_delivered_price' => $objGBmatch["quoted_delivered_price"],
											'acc_status' => $acc_status,
											'account_owner' => trim($objGBmatch["account_owner"]),
											'lastcrmemp' => trim($lastcrmemp),
											'lastcrmdt' => $lastcrmdt,
											'industry' => $industry,
											'quote_date' => $quote_date,
											'g_no_of_quote_sent1' => $g_no_of_quote_sent1,
											'lastcrmdt_sort' => $lastcrmdt_sort,
											'new_quote_id' => $new_quote_id,
											'quote_price' => $objGBmatch["quote_price"],
											'quote_status' => $objGBmatch["quote_status"]
										);
									}
                            ...
                            <?php
									...
									if ($_REQUEST["showall_emp"] == "yes") {
										$matchStr = "Select boxes.quantity, boxes.salePrice, boxes.shipfinal , quote_to_item.quote_id, companyInfo.ID as companyID, companyInfo.status, companyInfo.last_date, companyInfo.nickname, companyInfo.last_contact_date, companyInfo.company, companyInfo.shipCity, companyInfo.shipState, companyInfo.email, companyInfo.industry_id, employees.name, employees.initials from boxes INNER JOIN companyInfo ON boxes.companyID = companyInfo.id INNER JOIN quote_to_item ON boxes.ID = quote_to_item.item_id INNER JOIN employees ON companyInfo.assignedto = employees.employeeID WHERE companyInfo.status <> 31 and inventoryID = " . $_REQUEST["inventoryID"] . " AND employeeID = '" . $logged_emp_id . "'"
											. $transTypeQry . "  group by boxes.companyID";
									} else {
										if ($_REQUEST["employeeID"] > 0) {
											...
											$matchStr = "Select boxes.quantity, boxes.salePrice, boxes.shipfinal, quote_to_item.quote_id, companyInfo.ID as companyID, companyInfo.status, companyInfo.last_date, companyInfo.last_contact_date, companyInfo.nickname, companyInfo.company, companyInfo.shipCity, companyInfo.shipState, companyInfo.email, companyInfo.industry_id, employees.name, employees.initials from boxes INNER JOIN companyInfo ON boxes.companyID = companyInfo.id INNER JOIN quote_to_item ON boxes.ID = quote_to_item.item_id INNER JOIN employees ON companyInfo.assignedto = employees.employeeID WHERE companyInfo.status <> 31 and inventoryID = " . $_REQUEST["inventoryID"] .  $transTypeQry . " group by boxes.companyID";
										}
									}
									...
									while ($objGBmatch = array_shift($res1)) {
										...
										while ($quote_rows1 = array_shift($dt_view_res3)) {
											...
											$boxSql = "Select boxes.quantity, boxes.salePrice, boxes.shipfinal from boxes INNER JOIN companyInfo ON boxes.companyID = companyInfo.id INNER JOIN quote_to_item ON boxes.ID = quote_to_item.item_id INNER JOIN employees ON companyInfo.assignedto = employees.employeeID WHERE companyInfo.status <> 31 and boxes.item = 'Delivery' and quote_to_item.quote_id = '" . $objGBmatch["quote_id"] . "' " . $transTypeQry . " group by boxes.companyID";
											db_b2b();
											$dt_view_res4 = db_query($boxSql);
											while ($objQStatus = array_shift($dt_view_res4)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if (date('m/d/Y', strtotime($quote_date)) == "12/31/1969")			echo "Quote Removed";
												else		echo date('m/d/Y', strtotime($quote_date)); ?>
                                </td>
            ...
            <?php
										...
										$MGArray[] = array(
											'companyID' => $objGBmatch["companyID"],
											'company_name' => trim($nickname),
											'selltoemail' => trim($objGBmatch["email"]),
											'acc_status' => $acc_status,
											'account_owner' => trim($objGBmatch["name"]),
											'lastcrmemp' => trim($lastcrmemp),
											'lastcrmdt' => $lastcrmdt,
											'industry' => $industry,
											'quote_date' => $quote_date,
											'quoted_delivered_price' => $quoted_delivered_price,
											'g_no_of_quote_sent1' => $g_no_of_quote_sent1,
											'lastcrmdt_sort' => $lastcrmdt_sort,
											'new_quote_id' => $new_quote_id,
...
-->
        ...
        <tr>
            ...
            <td>
                <?php
									if (date('m/d/Y', strtotime($MGArraytmp2["quote_date"])) == "12/31/1969")			echo "Quote Removed";
									else	echo date('m/d/Y', strtotime($MGArraytmp2["quote_date"]));		?>
            </td>
            ...
            <td> <a href="viewCompany.php?ID=<?php echo $MGArraytmp2["companyID"] ?>"
                    target="_blank"><?php echo $MGArraytmp2["company_name"]; ?> </a></td>
