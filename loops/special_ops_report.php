							...
							<tr>
								...
								<td valign="top" width="1200px">
									...
									<select name="owner_name" id="owner_name">
										...
										?>
											<option value="<?php echo $owner_row["b2b_id"] ?>" <? if (isset($_REQUEST["owner_name"])) {
																									if ($_REQUEST["owner_name"] == $owner_row["b2b_id"]) {
																										echo " selected ";
																									}
																								} else {
																									if ($_COOKIE['b2b_id'] == $owner_row["b2b_id"]) {
																										echo " selected ";
																									}
					...
					<td width='1400' valign='top'>
						...
						?>
							<table width="1400" border="0" cellspacing="1" cellpadding="1">
								...
								<tr>
									<td bgcolor="#D9F2FF" width="5%" align="center">
										<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">
											Account Owner
											<a href="<?php echo htmlentities($_SERVER['PHP_SELF'] . "?sk=ei&so=A&show=" . $_REQUEST["show"] . "&owner_name=" . $owner_name . "&emp_filter=" . $emp_filter . "&statusid=" . $_REQUEST["statusid"]  . "&searchterm=" . $_REQUEST["searchterm"] . "&andor=" . $_REQUEST["andor"] . "&state=" . $_REQUEST["state"] ."&transactionType=". $_REQUEST['transactionType'] ."&transactionType=". $_REQUEST['transactionType']); ?>"><img src='images/sort_asc.png' width='6px;' height='12px;'></a>
											<a href="<?php echo htmlentities($_SERVER['PHP_SELF'] . "?sk=ei&so=D&show=" . $_REQUEST["show"] . "&owner_name=" . $owner_name . "&emp_filter=" . $emp_filter . "&statusid=" . $_REQUEST["statusid"]  . "&searchterm=" . $_REQUEST["searchterm"] . "&andor=" . $_REQUEST["andor"] . "&state=" . $_REQUEST["state"] ."&transactionType=". $_REQUEST['transactionType'] ."&transactionType=". $_REQUEST['transactionType']); ?>"><img src='images/sort_desc.png' width='6px;' height='12px;'></a>
										</font>
									</td>
									...
									<td width="7%" bgcolor="#D9F2FF">
										<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">
											Account Status
											<a href="<?php echo htmlentities($_SERVER['PHP_SELF'] . "?sk=nstatus&so=A&show=" . $_REQUEST["show"] . "&owner_name=" . $owner_name . "&emp_filter=" . $emp_filter . "&btnsubmit=" . $_REQUEST["btnsubmit"] . "&statusid=" . $_REQUEST["statusid"] . "&searchterm=" . $_REQUEST["searchterm"] . "&andor=" . $_REQUEST["andor"] . "&state=" . $_REQUEST["state"] ."&transactionType=". $_REQUEST['transactionType']); ?>"><img src='images/sort_asc.png' width='6px;' height='12px;'></a>
											<a href="<?php echo htmlentities($_SERVER['PHP_SELF'] . "?sk=nstatus&so=D&show=" . $_REQUEST["show"] . "&owner_name=" . $owner_name . "&emp_filter=" . $emp_filter . "&btnsubmit=" . $_REQUEST["btnsubmit"] . "&statusid=" . $_REQUEST["statusid"] . "&searchterm=" . $_REQUEST["searchterm"] . "&andor=" . $_REQUEST["andor"] . "&state=" . $_REQUEST["state"] ."&transactionType=". $_REQUEST['transactionType']); ?>"><img src='images/sort_desc.png' width='6px;' height='12px;'></a>
										</font><br>
									...
									<td bgcolor="#D9F2FF" width="20%" align="center">
										<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">
											<?php if ($row["sales_flg"] == "3") { ?>
												UCBZW Next Step
												<a href="<?php echo htmlentities($_SERVER['PHP_SELF'] . "?sk=uzns&so=A&show=" . $_REQUEST["show"] . "&owner_name=" . $owner_name . "&emp_filter=" . $emp_filter . "&statusid=" . $_REQUEST["statusid"]  . "&searchterm=" . $_REQUEST["searchterm"] . "&andor=" . $_REQUEST["andor"] . "&state=" . $_REQUEST["state"] ."&transactionType=". $_REQUEST['transactionType']); ?>"><img src='images/sort_asc.png' width='6px;' height='12px;'></a>
												<a href="<?php echo htmlentities($_SERVER['PHP_SELF'] . "?sk=uzns&so=D&show=" . $_REQUEST["show"] . "&owner_name=" . $owner_name . "&emp_filter=" . $emp_filter . "&statusid=" . $_REQUEST["statusid"]  . "&searchterm=" . $_REQUEST["searchterm"] . "&andor=" . $_REQUEST["andor"] . "&state=" . $_REQUEST["state"] ."&transactionType=". $_REQUEST['transactionType']); ?>"><img src='images/sort_desc.png' width='6px;' height='12px;'></a>

											<?php } else { ?>
												Next Step
												<a href="<?php echo htmlentities($_SERVER['PHP_SELF'] . "?sk=ns&so=A&show=" . $_REQUEST["show"] . "&owner_name=" . $owner_name . "&emp_filter=" . $emp_filter . "&statusid=" . $_REQUEST["statusid"]  . "&searchterm=" . $_REQUEST["searchterm"] . "&andor=" . $_REQUEST["andor"] . "&state=" . $_REQUEST["state"] ."&transactionType=". $_REQUEST['transactionType']); ?>"><img src='images/sort_asc.png' width='6px;' height='12px;'></a>
												<a href="<?php echo htmlentities($_SERVER['PHP_SELF'] . "?sk=ns&so=D&show=" . $_REQUEST["show"] . "&owner_name=" . $owner_name . "&emp_filter=" . $emp_filter . "&statusid=" . $_REQUEST["statusid"]  . "&searchterm=" . $_REQUEST["searchterm"] . "&andor=" . $_REQUEST["andor"] . "&state=" . $_REQUEST["state"] ."&transactionType=". $_REQUEST['transactionType']); ?>"><img src='images/sort_desc.png' width='6px;' height='12px;'></a>
											<?php } ?>
										</font>
									</td>
									...
									<td bgcolor="#D9F2FF" width="9%" align="center">
										<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">
											Why This Deal?
											<a href="<?php echo htmlentities($_SERVER['PHP_SELF'] . "?sk=sort_why_this_deal&so=A&show=" . $_REQUEST["show"] . "&owner_name=" . $owner_name . "&emp_filter=" . $emp_filter . "&statusid=" . $_REQUEST["statusid"] . "&searchterm=" . $_REQUEST["searchterm"] . "&andor=" . $_REQUEST["andor"] . "&state=" . $_REQUEST["state"] ."&transactionType=". $_REQUEST['transactionType']); ?>"><img src='images/sort_asc.png' width='6px;' height='12px;'></a>
											<a href="<?php echo htmlentities($_SERVER['PHP_SELF'] . "?sk=sort_why_this_deal&so=D&show=" . $_REQUEST["show"] . "&owner_name=" . $owner_name . "&emp_filter=" . $emp_filter . "&statusid=" . $_REQUEST["statusid"] . "&searchterm=" . $_REQUEST["searchterm"] . "&andor=" . $_REQUEST["andor"] . "&state=" . $_REQUEST["state"] ."&transactionType=". $_REQUEST['transactionType']); ?>"><img src='images/sort_desc.png' width='6px;' height='12px;'></a>
										</font>
									</td>
									<td bgcolor="#D9F2FF" width="6%" align="center">
										<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">
											Potential Annual Revenue
											<a href="<?php echo htmlentities($_SERVER['PHP_SELF'] . "?sk=sort_potential_annual_rev&so=A&show=" . $_REQUEST["show"] . "&owner_name=" . $owner_name . "&emp_filter=" . $emp_filter . "&statusid=" . $_REQUEST["statusid"] . "&searchterm=" . $_REQUEST["searchterm"] . "&andor=" . $_REQUEST["andor"] . "&state=" . $_REQUEST["state"] ."&transactionType=". $_REQUEST['transactionType']); ?>"><img src='images/sort_asc.png' width='6px;' height='12px;'></a>
											<a href="<?php echo htmlentities($_SERVER['PHP_SELF'] . "?sk=sort_potential_annual_rev&so=D&show=" . $_REQUEST["show"] . "&owner_name=" . $owner_name . "&emp_filter=" . $emp_filter . "&statusid=" . $_REQUEST["statusid"] . "&searchterm=" . $_REQUEST["searchterm"] . "&andor=" . $_REQUEST["andor"] . "&state=" . $_REQUEST["state"] ."&transactionType=". $_REQUEST['transactionType']); ?>"><img src='images/sort_desc.png' width='6px;' height='12px;'></a>
										</font>
									</td>
									...
									<td bgcolor="#D9F2FF" width="9%" align="center">
										<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">
											Last Communication
											<a href="<?php echo htmlentities($_SERVER['PHP_SELF'] . "?sk=lc&so=A&show=" . $_REQUEST["show"] . "&owner_name=" . $owner_name . "&emp_filter=" . $emp_filter . "&statusid=" . $_REQUEST["statusid"]  . "&searchterm=" . $_REQUEST["searchterm"] . "&andor=" . $_REQUEST["andor"] . "&state=" . $_REQUEST["state"] ."&transactionType=". $_REQUEST['transactionType']); ?>"><img src='images/sort_asc.png' width='6px;' height='12px;'></a>
											<a href="<?php echo htmlentities($_SERVER['PHP_SELF'] . "?sk=lc&so=D&show=" . $_REQUEST["show"] . "&owner_name=" . $owner_name . "&emp_filter=" . $emp_filter . "&statusid=" . $_REQUEST["statusid"]  . "&searchterm=" . $_REQUEST["searchterm"] . "&andor=" . $_REQUEST["andor"] . "&state=" . $_REQUEST["state"] ."&transactionType=". $_REQUEST['transactionType']); ?>"><img src='images/sort_desc.png' width='6px;' height='12px;'></a>
										</font>
									</td>
									<td bgcolor="#D9F2FF" width="9%" align="center">
										<font size="1" face="Arial, Helvetica, sans-serif" color="#333333">
											<?php if ($row["sales_flg"] == "3") { ?>
												...
												<a href="<?php echo htmlentities($_SERVER['PHP_SELF'] . "?sk=uznd&so=A&show=" . $_REQUEST["show"] . "&owner_name=" . $owner_name . "&emp_filter=" . $emp_filter . "&statusid=" . $_REQUEST["statusid"] . "&searchterm=" . $_REQUEST["searchterm"] . "&andor=" . $_REQUEST["andor"] . "&state=" . $_REQUEST["state"] ."&transactionType=". $_REQUEST['transactionType']); ?>"><img src='images/sort_asc.png' width='6px;' height='12px;'></a>
												<a href="<?php echo htmlentities($_SERVER['PHP_SELF'] . "?sk=uznd&so=D&show=" . $_REQUEST["show"] . "&owner_name=" . $owner_name . "&emp_filter=" . $emp_filter . "&statusid=" . $_REQUEST["statusid"] . "&searchterm=" . $_REQUEST["searchterm"] . "&andor=" . $_REQUEST["andor"] . "&state=" . $_REQUEST["state"] ."&transactionType=". $_REQUEST['transactionType']); ?>"><img src='images/sort_desc.png' width='6px;' height='12px;'></a>
											<?php } else { ?>

												Next Communication
												<a href="<?php echo htmlentities($_SERVER['PHP_SELF'] . "?sk=nd&so=A&show=" . $_REQUEST["show"] . "&owner_name=" . $owner_name . "&emp_filter=" . $emp_filter . "&statusid=" . $_REQUEST["statusid"] . "&searchterm=" . $_REQUEST["searchterm"] . "&andor=" . $_REQUEST["andor"] . "&state=" . $_REQUEST["state"] ."&transactionType=". $_REQUEST['transactionType']); ?>"><img src='images/sort_asc.png' width='6px;' height='12px;'></a>
												<a href="<?php echo htmlentities($_SERVER['PHP_SELF'] . "?sk=nd&so=D&show=" . $_REQUEST["show"] . "&owner_name=" . $owner_name . "&emp_filter=" . $emp_filter . "&statusid=" . $_REQUEST["statusid"] . "&searchterm=" . $_REQUEST["searchterm"] . "&andor=" . $_REQUEST["andor"] . "&state=" . $_REQUEST["state"] ."&transactionType=". $_REQUEST['transactionType']); ?>"><img src='images/sort_desc.png' width='6px;' height='12px;'></a>
											<?php } ?>
										</font>
									</td>
								...
								where companyInfo.status in (3,94,95,96,97,98,99,100,101,32,50,102,103,51,56,104,105,24,43,106,52,33,31,65,107,108,109,44,112,110,111,70,115,73,116,117,118,119,120,55,122,123,124,38,125,126,127,121,49,113,114)  $transTypeQry";
