...
<table cellSpacing="1" cellPadding="1" border="0" width="250">
    ...
    <tr vAlign="center">
        ...
        <td bgColor="#e4e4e4" class="style12" style="width: 10%">
            <a href="pending_shipments.php?tbl=<?php echo ("losangeles");?>&posting=yes" target="_blank">
                <?php echo $count_pc; ?>
            </a>
        </td>
        <td bgColor="#e4e4e4" class="style12" style="width: 10%">
            <a href="shipments_shipped.php?tbl=<?php echo ("losangeles");?>&posting=yes" target="_blank">
    ...
    <tr vAlign="center">
        ...
        <td bgColor="#e4e4e4" class="style12" style="width: 10%">
            <a href="pending_shipments.php?tbl=<?php echo ("huntvally");?>&posting=yes" target="_blank">
                <?php echo $count_pc2; ?>
            </a>
        </td>
        <td bgColor="#e4e4e4" class="style12" style="width: 10%">
    ...
    <tr vAlign="center">
        ...
        <td bgColor="#e4e4e4" class="style12" style="width: 10%">
            <a href="pending_shipments.php?tbl=<?php echo ("hannibal");?>&posting=yes" target="_blank">
                <?php echo $count_pc3; ?>
            </a>
        </td>
        <td bgColor="#e4e4e4" class="style12" style="width: 10%">
    ...
    <tr vAlign="center">
        ...
        <td bgColor="#e4e4e4" class="style12" style="width: 10%">
            <a href="pending_shipments.php?tbl=<?php echo ("saltlake");?>&posting=yes" target="_blank">
                <?php echo $count_pc4; ?>
            </a>
        </td>
        <td bgColor="#e4e4e4" class="style12" style="width: 10%">
    ...
    <tr vAlign="center">
        ...
        <td bgColor="#e4e4e4" class="style12" style="width: 10%">
            <a href="pending_shipments.php?tbl=<?php echo ("newitem");?>&posting=yes" target="_blank">
                <?php echo $count_pc5; ?>
            </a>
        </td>
        <td bgColor="#e4e4e4" class="style12" style="width: 10%">
...
<table cellSpacing="1" cellPadding="1" border="0" width="200">
    ...
    <tr vAlign="center">
        ...
        <td bgColor="#e4e4e4" class="style12" style="width: 10%">
            <a href="report_survey.php?action=run&start_date=<?php echo $end_date; ?>&end_date=<?php echo $start_date; ?>&surveyview=1">
    ...
    <tr>
        <td colspan="2" bgColor="#e4e4e4" class="style12" style="width: 10%">
            <a href="load_survey.php">Manually Update
            </a>
            <div class="tooltip">
...
<?php
$dupqry = "SELECT * FROM (SELECT count( tracking_number ) AS total
